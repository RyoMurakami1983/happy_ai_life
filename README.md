...
- **この repo を改善:** [開発ガイド](docs/DEVELOPMENT.md) を開き、`grill-with-docs` → `design-and-plan` → `implement` へ進む
...
3. **設計** — 必要に応じて `design-and-plan` で構造判断と plan の土台を固める
4. **実装** — `implement` で実装と完了処理を進める
5. **確認** — 変更範囲に合う focused check を流す
