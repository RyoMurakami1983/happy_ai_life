...
- `home-template/.copilot/`: 個人環境向けテンプレート。home sync で配るのは `skills/`、`agents/`、`copilot-instructions.md`、`mcp-config.sample.json`
- `home-template/.copilot/docs/furikaeri/`: home 側に残すふりかえり archive の雛形
- `scripts/`: 同期スクリプト
