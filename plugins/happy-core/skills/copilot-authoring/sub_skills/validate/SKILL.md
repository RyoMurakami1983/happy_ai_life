...
uv run python plugins/happy-core/skills/copilot-authoring/_eval/scripts/validate_agent.py plugins/happy-coding/agents/<agent-name>.agent.md --level L2
```
