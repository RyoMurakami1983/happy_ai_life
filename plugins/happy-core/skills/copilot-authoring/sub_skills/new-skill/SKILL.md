...
```powershell
uv run python plugins\happy-core\skills\copilot-authoring\_skill\scripts\create_skill.py --name <skill-name> --description "<description>"
uv run python plugins\happy-core\skills\copilot-authoring\_skill\scripts\create_skill.py --name <router-name> --description "<description>" --type router --sub-skills <route-a>,<route-b>
```
