...
description: >
  ...
  1 つの入口にまとめる。試作から `plugins/*` 配布へ昇格するときの name /
  description 整備も扱う。Use when: skill / agent / repo-wide instructions /
  path-specific instructions を新規作成したいとき、既存定義を育てたいとき、公開前に責務や導線を確かめたいとき。
