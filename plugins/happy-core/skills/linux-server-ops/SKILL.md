...
今回の実務で得た手順を、短い再利用可能な flow として残し、詳細は Gist へ分離して管理できるようにします。
...
詳細な実務手順は Gist で管理し、この skill では最短の操作導線だけを残します。

- Gist: https://gist.github.com/RyoMurakami1983/acccf357dedd49660915a3e0826c3c68
