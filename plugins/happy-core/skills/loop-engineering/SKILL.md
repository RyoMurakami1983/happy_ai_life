...
- 後続 Issue を素早く残す: `happy-add-issue`
- 後続 Issue を丁寧に具体化する / 公開向け匿名化まで見る: `gh-issue-create`
...
| follow-up を軽く Issue 化して次のループへ渡す | `happy-add-issue` |
| follow-up を公開向けに丁寧に具体化する | `gh-issue-create` |
...
- `happy-add-issue` — 作業中に見つけた改善点を軽く backlog 化する入口
