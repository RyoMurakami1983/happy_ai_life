...
description: >
  こんなときに使う: WPF アプリに DPAPI 暗号化された設定管理を追加し、資格情報を
  安全に保存したいとき。WPF アプリケーションで暗号化済み設定を用意したいとき。
---
...
> 完全な実装は [references/detailed-patterns.md](references/detailed-patterns.md#dpapiencryptor--full-implementation) を参照。
...
namespace YourApp.Infrastructure.Configuration
{
    ...
    public class AppConfigModel
    {
        ...
        // public NewIntegrationConfigModel ServiceA { get; set; } = new();  // 新しい統合が追加
        // public NewIntegrationConfigModel ServiceB { get; set; } = new();  // 新しい統合が追加
...
> 完全な実装は [references/detailed-patterns.md](references/detailed-patterns.md#secureconfigservice--full-implementation) を参照。
