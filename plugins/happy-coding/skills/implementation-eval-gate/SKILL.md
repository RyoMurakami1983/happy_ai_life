...
- `implement` の実装フェーズで、自己正当化を避ける批判的 gate を挟みたいとき
...
| contract / design が曖昧、または前提が崩れた | grill-with-docs / design-and-plan に戻す | `REPLAN_REQUIRED` |
...
出力は、generator や `implement` が次の一歩を迷わない形で返します。
