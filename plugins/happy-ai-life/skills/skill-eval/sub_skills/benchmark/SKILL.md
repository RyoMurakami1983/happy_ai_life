...
```
uv run python plugins/happy-ai-life/skills/skill-eval/_eval/scripts/aggregate_benchmark.py \
...
```
uv run python plugins/happy-ai-life/skills/skill-eval/_eval/scripts/generate_viewer.py \
  --skill-id <skill-id>
```
