...
- 新しい workflow を `plugins/happy-ai-life/skills/` に追加したいとき
...
```powershell
uv run python plugins/happy-ai-life/skills/skill/scripts/create_skill.py --name <skill-name> --description "<description>"
uv run python plugins/happy-ai-life/skills/skill/scripts/create_skill.py --name <router-name> --description "<description>" --type router --sub-skills <route-a>,<route-b>
```
