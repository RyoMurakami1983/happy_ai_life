...
- `$HOME/.copilot/config.json` に入る managed safety hook を正式な global guard として docs / naming に反映する。
...
- [ ] managed hook entry の位置づけが enterprise/global guard として説明されている。
...
### 16. [P1] `docs/TRUST_BOUNDARY.md` を追加し信頼境界を整理する

### 17. [P1] `docs/HOOKS_GOVERNANCE.md` を追加し hooks の管理方針を整理する
