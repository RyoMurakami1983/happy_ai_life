...
## Amendment 2026-04-29: Copilot CLI plugin distribution と MCP config 撤退

- reusable skills / agents の公開・共有向け primary distribution は `plugins/happy-ai-life/` の Copilot CLI plugin とする。
...
| 公開・共有向け reusable assets | `plugins/happy-ai-life/` | Copilot CLI plugin の curated package |
...
#### plugin（`plugins/happy-ai-life/` / installed plugin）
