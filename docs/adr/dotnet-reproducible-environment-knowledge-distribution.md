...
- `home-template/.copilot/skills/dotnet-setup-dev-environment/SKILL.md`
- `home-template/.copilot/skills/dotnet/SKILL.md` の router 更新
...
repo をまたいで再利用したい .NET setup の手順は、`home-template/.copilot/skills/` に置く。  
...
- `home-template/.copilot/skills/dotnet/SKILL.md` は、基盤系 skill の追加余地を既に示している
