...
license: Personal
compatibility: "code-review-before-commit.agent.md, built-in /review or code-review agent"
---
...
| 状況 | 次にやること | 使うもの |
|---|---|---|
| ローカル差分の事前レビュー | Step 1 から開始 | `code-review-before-commit` agent |
...
1. `code-review-before-commit` custom agent を明示的に使う
