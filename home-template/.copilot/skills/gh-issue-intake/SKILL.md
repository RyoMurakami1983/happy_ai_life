...
- `🟢 gh-issue-intake: Issueは日本語で起票する方針を明記する`
...
```markdown
Title: "🟢 gh-issue-intake: 受け入れ条件の書き方を明記する"
...
## 提案
`gh-issue-intake` に、挙動変更や運用変更を含むIssueでは Acceptance Criteria を必須にするルールを追記する。
...
## Definition of Done
- [ ] `gh-issue-intake` のテンプレと例が更新されている
