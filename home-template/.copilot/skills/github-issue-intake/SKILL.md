...
```markdown
Title: "🟢 github-issue-intake: 受け入れ条件の書き方を明記する"
...
## 提案
`github-issue-intake` に、挙動変更や運用変更を含むIssueでは Acceptance Criteria を必須にするルールを追記する。
...
## Definition of Done
- [ ] `github-issue-intake` のテンプレと例が更新されている
