...
description: >
  ...
  planner に渡す。
  Use when: 仕様が固まり設計を始めたいとき、実装計画の前に構造とセキュリティを確認したいとき。
compatibility: >
...
仕様書を技術設計書に落とし込み、構造・言語適合・セキュリティの3面で検証するワークフロー skill です。spec-workshop の後段、planner の前段に位置します。設計と計画を分離する理由は、設計の再検証や部分的なやり直しが計画に波及しないようにするためです。
