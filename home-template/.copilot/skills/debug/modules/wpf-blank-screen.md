# WPF Blank Screen Debug Module

Use this module when a WPF window shows a blank (white) screen instead of expected content.

Start here before blaming bindings, navigation, or data. Most blank screens have a simpler structural cause.
