...
function Get-MinimalGuardPolicy {
    return [pscustomobject]@{
        ...
        denyCommandRules = @(
            ...
            [pscustomobject]@{ id = "rm-rf-root"; kind = "pattern"; matchAgainst = "normalized"; description = "Block recursive forced rm against root."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*\s-[a-z]*r[a-z]*f[a-z]*[^;&|]*\s+\/(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-fr-root"; kind = "pattern"; matchAgainst = "normalized"; description = "Block forced recursive rm against root."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*\s-[a-z]*f[a-z]*r[a-z]*[^;&|]*\s+\/(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-r-f-root"; kind = "pattern"; matchAgainst = "normalized"; description = "Block split recursive forced rm against root."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*\s-[a-z]*r[a-z]*(?=\s|$|[;&|])[^;&|]*\s-[a-z]*f[a-z]*[^;&|]*\s+\/(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-f-r-root"; kind = "pattern"; matchAgainst = "normalized"; description = "Block split forced recursive rm against root."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*\s-[a-z]*f[a-z]*(?=\s|$|[;&|])[^;&|]*\s-[a-z]*r[a-z]*[^;&|]*\s+\/(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-rf-dot"; kind = "pattern"; matchAgainst = "normalized"; description = "Block recursive forced rm against current directory."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*\s-[a-z]*r[a-z]*f[a-z]*[^;&|]*\s+\.\/?(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-fr-dot"; kind = "pattern"; matchAgainst = "normalized"; description = "Block forced recursive rm against current directory."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*\s-[a-z]*f[a-z]*r[a-z]*[^;&|]*\s+\.\/?(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-r-f-dot"; kind = "pattern"; matchAgainst = "normalized"; description = "Block split recursive forced rm against current directory."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*\s-[a-z]*r[a-z]*(?=\s|$|[;&|])[^;&|]*\s-[a-z]*f[a-z]*[^;&|]*\s+\.\/?(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-f-r-dot"; kind = "pattern"; matchAgainst = "normalized"; description = "Block split forced recursive rm against current directory."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*\s-[a-z]*f[a-z]*(?=\s|$|[;&|])[^;&|]*\s-[a-z]*r[a-z]*[^;&|]*\s+\.\/?(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-recursive-force-root"; kind = "pattern"; matchAgainst = "normalized"; description = "Block recursive forced rm with long options against root."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*(?:\s-[a-z]*r[a-z]*|\s--recursive)(?=\s|$|[;&|])[^;&|]*(?:\s-[a-z]*f[a-z]*|\s--force)(?=\s|$|[;&|])[^;&|]*\s+\/(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-force-recursive-root"; kind = "pattern"; matchAgainst = "normalized"; description = "Block forced recursive rm with long options against root."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*(?:\s-[a-z]*f[a-z]*|\s--force)(?=\s|$|[;&|])[^;&|]*(?:\s-[a-z]*r[a-z]*|\s--recursive)(?=\s|$|[;&|])[^;&|]*\s+\/(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-recursive-force-dot"; kind = "pattern"; matchAgainst = "normalized"; description = "Block recursive forced rm with long options against current directory."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*(?:\s-[a-z]*r[a-z]*|\s--recursive)(?=\s|$|[;&|])[^;&|]*(?:\s-[a-z]*f[a-z]*|\s--force)(?=\s|$|[;&|])[^;&|]*\s+\.\/?(?=\s|$|[;&|])' }
            [pscustomobject]@{ id = "rm-force-recursive-dot"; kind = "pattern"; matchAgainst = "normalized"; description = "Block forced recursive rm with long options against current directory."; pattern = '(^|[;&|]\s*)(?:(?:sudo|doas)\s+)?(?:(?:cmd|cmd\.exe)\s+\/c\s+)?(?:(?:sudo|doas)\s+)?rm[^;&|]*(?:\s-[a-z]*f[a-z]*|\s--force)(?=\s|$|[;&|])[^;&|]*(?:\s-[a-z]*r[a-z]*|\s--recursive)(?=\s|$|[;&|])[^;&|]*\s+\.\/?(?=\s|$|[;&|])' }
