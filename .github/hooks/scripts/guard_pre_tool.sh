...
[
  {"id":"rm-rf-root","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*\\s-[a-z]*r[a-z]*f[a-z]*[^;&|]*\\s+\\/(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-fr-root","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*\\s-[a-z]*f[a-z]*r[a-z]*[^;&|]*\\s+\\/(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-r-f-root","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*\\s-[a-z]*r[a-z]*(?=\\s|$|[;&|])[^;&|]*\\s-[a-z]*f[a-z]*[^;&|]*\\s+\\/(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-f-r-root","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*\\s-[a-z]*f[a-z]*(?=\\s|$|[;&|])[^;&|]*\\s-[a-z]*r[a-z]*[^;&|]*\\s+\\/(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-rf-dot","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*\\s-[a-z]*r[a-z]*f[a-z]*[^;&|]*\\s+\\.\\/?(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-fr-dot","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*\\s-[a-z]*f[a-z]*r[a-z]*[^;&|]*\\s+\\.\\/?(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-r-f-dot","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*\\s-[a-z]*r[a-z]*(?=\\s|$|[;&|])[^;&|]*\\s-[a-z]*f[a-z]*[^;&|]*\\s+\\.\\/?(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-f-r-dot","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*\\s-[a-z]*f[a-z]*(?=\\s|$|[;&|])[^;&|]*\\s-[a-z]*r[a-z]*[^;&|]*\\s+\\.\\/?(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-recursive-force-root","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*(?:\\s-[a-z]*r[a-z]*|\\s--recursive)(?=\\s|$|[;&|])[^;&|]*(?:\\s-[a-z]*f[a-z]*|\\s--force)(?=\\s|$|[;&|])[^;&|]*\\s+\\/(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-force-recursive-root","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*(?:\\s-[a-z]*f[a-z]*|\\s--force)(?=\\s|$|[;&|])[^;&|]*(?:\\s-[a-z]*r[a-z]*|\\s--recursive)(?=\\s|$|[;&|])[^;&|]*\\s+\\/(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-recursive-force-dot","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*(?:\\s-[a-z]*r[a-z]*|\\s--recursive)(?=\\s|$|[;&|])[^;&|]*(?:\\s-[a-z]*f[a-z]*|\\s--force)(?=\\s|$|[;&|])[^;&|]*\\s+\\.\\/?(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
  {"id":"rm-force-recursive-dot","pattern":"(^|[;&|]\\s*)(?:(?:sudo|doas)\\s+)?(?:(?:cmd|cmd\\.exe)\\s+\\/c\\s+)?(?:(?:sudo|doas)\\s+)?(?:(?:(?:bash|sh|powershell|pwsh)(?:\\.exe)?)(?:\\s+\\S+)*\\s+-(?:c|lc|command)\\s+(?:\"|')?)?(?:(?:sudo|doas)\\s+)?rm[^;&|]*(?:\\s-[a-z]*f[a-z]*|\\s--force)(?=\\s|$|[;&|])[^;&|]*(?:\\s-[a-z]*r[a-z]*|\\s--recursive)(?=\\s|$|[;&|])[^;&|]*\\s+\\.\\/?(?=\\s|$|[;&|]|[\"'])","matchAgainst":"normalized"},
